function Navbar() {
  return (
    <nav class="border-gray-200 mb-10">
      <div class="max-w-screen-xl flex flex-wrap align-middle items-center justify-start mx-auto">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          <ul class="flex flex-col text-sm font-bold mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent uppercase">
            <li>
              <a
                href="/"
                class="block py-2 pl-3 pr-4 text-gray-600 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 no-underline  md:hover:text-blue-700 md:p-0 "
              >
                Restaurantes
              </a>
            </li>
            <li>
              <a
                href="/reservas"
                class="block py-2 pl-3 pr-4 no-underline text-gray-600 rounded hover:bg-gray-100 md:hover:bg-transparent  md:border-0 md:hover:text-blue-700 md:p-0 "
              >
                Reservas
              </a>
            </li>
